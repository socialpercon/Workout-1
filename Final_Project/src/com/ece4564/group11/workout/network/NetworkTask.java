...
public class NetworkTask extends AsyncTask<String, Integer, HttpEntity>{
	...
	protected HttpEntity doInBackground(String... args) 
	{
		...
		if (args[0].equals("stay"))
		{
	        ...
	        nameValuePairs.add(new BasicNameValuePair("lat", Double.toString(location_.getLat())));
	        nameValuePairs.add(new BasicNameValuePair("lon", Double.toString(location_.getLon())));
	        nameValuePairs.add(new BasicNameValuePair("top", Long.toString(unique_id.getMostSignificantBits())));
	        nameValuePairs.add(new BasicNameValuePair("bot", Long.toString(unique_id.getLeastSignificantBits())));
